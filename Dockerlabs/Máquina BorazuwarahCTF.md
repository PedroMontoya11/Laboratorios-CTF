Desplegamos la máquina vulnerable poniendo en la terminal la línea de comandos bash auto_deploy.sh borazuwarahctf.tar en la carpeta donde se encuentre el contenido extraído del zip.
